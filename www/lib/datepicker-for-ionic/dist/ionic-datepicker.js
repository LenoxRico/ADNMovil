...
(function() {
  ...
  .controller('DatepickerCtrl', [ '$scope', 'DatepickerService', function ($scope, DatepickerService,$rootScope) {
...
(function() {
  ...
  .service('DatepickerService', [ 'DatepickerNls', function (DatepickerNls) {
    ...
    $rootScope.getYears = function() {
      $rootScope.ano = [];
      for (var i = 1900; i < 2101; i++) $rootScope.ano.push(i);
        console.log($rootScope.ano);
      return $rootScope.ano;
    };
