var adnApp = angular.module('CONSULTA_BALANCE', []);

adnApp.controller('controllerConsultaBalance',function($scope,$rootScope,$http,$ionicLoading,$ionicPopup,$state,$timeout) {
 $scope.data = [];
  $scope.show = function() {
    $ionicLoading.show({
